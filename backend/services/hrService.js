...
export class HrService {
  ...
  savePayroll(input,actor){ this.requireTenant(actor); assert(input.staffId&&input.period,"Staff and period are required.",400); return this.databaseManager.withTransaction(c=>repo.upsertPayroll(c,actor.tenantId,{...input,id:input.id||createId('staff_pay')})); }
